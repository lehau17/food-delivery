...
func RegisterShipper(act appcontext.AppContect) func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		biz := userbiz.NewShipperRegisterBiz(store, md5, act.GetPubSub(), *act.GetRedis())
		if err := biz.RegisterShipper(c.Request.Context(), &data); err != nil {
			panic(err)
		}
