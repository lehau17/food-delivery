...
func IncreaseCart(appCtx appcontext.AppContect) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		repo := cartrepo.NewCartIncreaseQuantityRepo(store)
		biz := cartbiz.NewCartIncreaseQuantityBiz(repo)
		if err := biz.IncreaseQuantity(c.Request.Context(), &data); err != nil {
			panic(err)
		}
